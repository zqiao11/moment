# -*- coding: UTF-8 -*-
from tscil.data.grabmyo import window_len_grabmyo, input_channels_grabmyo
from tscil.data.ninapro import window_len_ninapro
from tscil.data.wisdm import window_len_wisdm
import os
